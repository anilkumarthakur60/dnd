...
export default defineConfig([
  ...
  // also swallow the `@anil-labs/dnd-core/styles.css` subpath, which must be
  // resolved and inlined by the `.css` text loader below.
  {
    ...
    external: ['@anil-labs/dnd-core'],
    noExternal: [/@anil-labs\/dnd-core\/styles\.css$/],
    loader: { '.css': 'text' },
  },
